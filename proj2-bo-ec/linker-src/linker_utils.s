...
inst_needs_relocation:
	# In this function we should be determining whether the instruction given is one of the two j type instructions
	li $t0, 0x3 #test whether the opcode is for jal
	li $t1, 0x2 #test whether the opcode is for j
	srl $a0, $a0, 26
